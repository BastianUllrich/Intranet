...
/**
 * RockSolid Custom Elements translations
 *
 * @author Martin Auswöger <martin@madeyourday.net>
 */

$GLOBALS['TL_LANG']['rocksolid_custom_elements']['new_list_item'] = 'Neues Element';
$GLOBALS['TL_LANG']['rocksolid_custom_elements']['list_item_up'] = 'Eine Position nach oben verschieben';
$GLOBALS['TL_LANG']['rocksolid_custom_elements']['list_item_down'] = 'Eine Position nach unten verschieben';
...
$GLOBALS['TL_LANG']['rocksolid_custom_elements']['list_item_duplicate'] = 'Element duplizieren';
