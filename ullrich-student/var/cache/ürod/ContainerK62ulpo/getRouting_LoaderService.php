...
$a->addLoader(${($_ = isset($this->services['contao.routing.frontend_loader']) ? $this->services['contao.routing.frontend_loader'] : ($this->services['contao.routing.frontend_loader'] = new \Contao\CoreBundle\Routing\FrontendLoader(false))) && false ?: '_'});
$a->addLoader($c);
