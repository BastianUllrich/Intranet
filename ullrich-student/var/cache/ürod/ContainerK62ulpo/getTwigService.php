...
$d = ${($_ = isset($this->services['knp_menu.matcher']) ? $this->services['knp_menu.matcher'] : $this->load('getKnpMenu_MatcherService.php')) && false ?: '_'};
$e = new \Symfony\Bridge\Twig\AppVariable();
$e->setEnvironment('ürod');
$e->setDebug(true);
...
$instance->addExtension(new \Symfony\Bridge\Twig\Extension\SecurityExtension(${($_ = isset($this->services['security.authorization_checker']) ? $this->services['security.authorization_checker'] : $this->load('getSecurity_AuthorizationCheckerService.php')) && false ?: '_'}));
...
$instance->addExtension(new \Symfony\Bridge\Twig\Extension\TranslationExtension(${($_ = isset($this->services['netzmacht.contao_toolkit.translation.translator']) ? $this->services['netzmacht.contao_toolkit.translation.translator'] : $this->getNetzmacht_ContaoToolkit_Translation_TranslatorService()) && false ?: '_'}));
...
$instance->addExtension(new \Knp\Menu\Twig\MenuExtension(new \Knp\Menu\Twig\Helper(${($_ = isset($this->services['knp_menu.renderer_provider']) ? $this->services['knp_menu.renderer_provider'] : $this->load('getKnpMenu_RendererProviderService.php')) && false ?: '_'}, ${($_ = isset($this->services['knp_menu.menu_provider']) ? $this->services['knp_menu.menu_provider'] : $this->load('getKnpMenu_MenuProviderService.php')) && false ?: '_'}, $c, $d), $d, $c));
$instance->addExtension(new \Knp\Bundle\TimeBundle\Twig\Extension\TimeExtension(${($_ = isset($this->services['time.templating.helper.time']) ? $this->services['time.templating.helper.time'] : $this->load('getTime_Templating_Helper_TimeService.php')) && false ?: '_'}));
...
$instance->addExtension(${($_ = isset($this->services['contao.twig.template_extension']) ? $this->services['contao.twig.template_extension'] : $this->load('getContao_Twig_TemplateExtensionService.php')) && false ?: '_'});
