 ...
 */
class appürodDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            ...
            'netzmacht.contao_toolkit.translation.translator' => 'getNetzmacht_ContaoToolkit_Translation_TranslatorService',
        ...
        $this->aliases = [
            ...
            'translator' => 'netzmacht.contao_toolkit.translation.translator',
        ];
    }
    ...
    {
        $this->services['monolog.handler.nested'] = $instance = new \Monolog\Handler\RotatingFileHandler(($this->targetDirs[2].'/logs/ürod.log'), 10, 200, true, NULL);
    ...
    /**
     * Gets the private 'netzmacht.contao_toolkit.translation.translator' shared service.
     *
     * @return \Netzmacht\Contao\Toolkit\Translation\LangArrayTranslatorBagTranslator
     */
    protected function getNetzmacht_ContaoToolkit_Translation_TranslatorService()
    {
        return $this->services['netzmacht.contao_toolkit.translation.translator'] = new \Netzmacht\Contao\Toolkit\Translation\LangArrayTranslatorBagTranslator(new \Symfony\Component\Translation\LoggingTranslator(${($_ = isset($this->services['translator.default']) ? $this->services['translator.default'] : $this->getTranslator_DefaultService()) && false ?: '_'}, ${($_ = isset($this->services['monolog.logger.translation']) ? $this->services['monolog.logger.translation'] : $this->getMonolog_Logger_TranslationService()) && false ?: '_'}), ${($_ = isset($this->services['contao.framework']) ? $this->services['contao.framework'] : $this->getContao_FrameworkService()) && false ?: '_'}, ${($_ = isset($this->services['logger']) ? $this->services['logger'] : $this->getLoggerService()) && false ?: '_'});
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Bundle\SecurityBundle\Debug\TraceableFirewallListener(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(new \Symfony\Component\DependencyInjection\ServiceLocator(['security.firewall.map.context.backend' => function () {
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'debug.container.dump': $value = ($this->targetDirs[0].'/appürodDebugProjectContainer.xml'); break;
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.container_class' => 'appürodDebugProjectContainer',
            ...
            'router.options.matcher.cache_class' => 'appürodDebugProjectContainerUrlMatcher',
            'router.options.generator.cache_class' => 'appürodDebugProjectContainerUrlGenerator',
            'router.request_context.host' => 'localhost',
            'router.request_context.scheme' => 'http',
            'router.request_context.base_url' => '',
            'router.resource' => 'contao_manager.routing_loader:loadFromPlugins',
            'router.cache_class_prefix' => 'appürodDebugProjectContainer',
