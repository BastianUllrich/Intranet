...
$catalogue = new MessageCatalogue('nl', array (
  ...
  'messages' => 
  array (
    'install_tool' => 'Contao installatie programma',
    'an_error_occurred' => 'Er is een fout opgetreden',
    'locked_headline' => 'Het installatie programma is geblokkeerd',
    'locked_explanation' => 'Om veiligheidsredenen is het installatietool vergrendeld nadat een verkeerd wachtwoord meer dan drie keer achter elkaar is ingevoerd. Je kunt het ontgrendelen in de Contao Manager of door <code>contao:install:unlock</code> uit te voeren op de opdrachtregel.',
    'file_permissions_headline' => 'Het is PHP niet toegestaan om bestanden te beschrijven!',
    'file_permissions_explanation' => 'Uw server ondersteunt geen toegang tot bestanden via PHP; hoogstwaarschijnlijk draait PHP als Apache module onder een andere gebruiker. Neem contact op met uw serverbeheerder en vraag hem om dit probleem op te lossen.',
    'file_permissions_warning' => '<strong>Ga dit niet oplossen door bestanden en mappen beschrijfbaar te maken voor iedereen!</strong>',
    'accept_license' => 'Accepteer licentie',
    'set_password' => 'Installatie programma wachtwoord',
    'set_password_hint' => 'Voer een wachtwoord in om onbevoegde toegang te voorkomen!',
    'password' => 'Wachtwoord',
    'confirmation' => 'Bevestiging',
    'save_password' => 'Wachtwoord opslaan',
    'password_confirmation_mismatch' => 'Het wachtwoord komt niet overeen met de bevestiging!',
    'password_too_short' => 'Het wachtwoord dient minstens %d karakters lang te zijn!',
    'login' => 'Inloggen',
    'login_explanation' => 'Geef het installatie programma wachtwoord op. Dit is niet hetzelfde als het Contao backend wachtwoord.',
    'allow_cookies' => 'U dient cookies toe te staan om Contao te kunnen gebruiken.',
    'invalid_password' => 'Ongeldig wachtwoord!',
    'database_connection' => 'Database verbinding',
    'database_connected' => 'Database verbinding tot stand gebracht.',
    'database_dot_in_dbname' => 'De databasenaam mag geen punten bevatten!',
    'database_could_not_connect' => 'Geen verbinding met een database!',
    'database_connection_explain' => 'Controleer uw gegevens om met de database te verbinden.',
    'database_host' => 'Host',
    'database_port' => 'Poortnummer',
    'database_user' => 'Gebruikersnaam',
    'database_password' => 'Wachtwoord',
    'database_name' => 'Naam database',
    'save_settings' => 'Bewaar instellingen',
    'update_tables' => 'Update de database',
    'update_tables_explain' => 'Houd er rekening mee dat de update-assistent alleen tabellen afhandelt welke met <code> tl _ </ code> beginnen.',
    'update_tables_confirm' => 'De database is up-to-date!',
    'update_save' => 'Update database',
    'CREATE' => 'Maak tabellen',
    'ALTER_ADD' => 'Voeg kolommen toe',
    'ALTER_CHANGE' => 'Wijzig kolommen',
    'ALTER_DROP' => 'Dump kolommen',
    'DROP' => 'Dump tabellen',
    'select_all' => 'Selecteer alles',
    'template_import' => 'Importeer een template',
    'template_import_explain' => 'Hier kunt u een <code>.sql</code> bestand importeren van de <code>templates</code> directory. Bestaande gegevens worden verwijderd! Als u alleen een thema wilt importeren, gebruik dan de thema-manager in het Contao backend.',
    'import_exception' => 'Importeren is mislukt! Is de database up-to-date en is het template bestand compatibel met uw Contao versie?',
    'import_empty_source' => 'Kies een template bestand!',
    'import_data_will_be_deleted' => 'Alle bestaande gegevens worden verwijderd!',
    'imported_on' => 'Template geïmporteerd bij %s',
    'templates' => 'Templates',
    'do_not_truncate' => 'Maak tabellen niet leeg',
    'import_confirm' => 'Alle bestaande gegevens worden verwijderd! Wilt u werkelijk verder gaan?',
    'template_save' => 'Importeer template',
    'admin_create' => 'Maak een admin gebruiker aan',
    'admin_create_explain' => 'Maak hier een admin gebruiker aan welke kan inloggen in het Contao backend.',
    'admin_confirm' => 'Een admin gebruiker is aangemaakt.',
    'admin_username' => 'Gebruikersnaam',
    'admin_name' => 'Naam',
    'admin_email' => 'E-mail',
    'admin_save' => 'Maak een admin gebruiker aan',
    'admin_error_extnd' => 'Om veiligheidsredenen kunt u de volgende karakters hier niet gebruiken: #<>()\\=',
    'admin_error_no_space' => 'De gebruikersnaam mag geen spaties bevatten!',
    'admin_error_email' => 'Geef een geldig e-mail adres op!',
    'admin_error_password_match' => 'De opgegeven wachtwoorden zijn niet gelijk!',
    'admin_error_password_user' => 'Uw gebruikersnaam en wachtwoord mogen niet gelijk zijn!',
    'admin_error' => 'Vul alle velden in om een admin gebruiker aan te maken!',
    'congratulations' => 'Gefeliciteerd!',
    'congratulations_explain' => 'Contao is met succes geïnstalleerd.',
    'installation_complete' => 'Installatie compleet',
    'installation_complete_explain' => 'Ga naar het Contao backend om de systeem instellingen te controleren.',
    'back_end' => 'Contao backend',
    'old_database' => 'De database is te oud!',
    'old_database_explanation' => 'U dient op zijn minst over Contao 3.2 te beschikken om om te kunnen upgraden naar Contao 4.',
    'console_explanation' => 'Een installatie opdracht kan niet worden voltooid!',
    'duplicate_subscriptions' => 'Dubbele abonnementen',
    'duplicate_subscriptions_begin' => 'Er werden dubbele inschrijvingen voor de nieuwsbrief gevonden:',
    'duplicate_subscriptions_end' => 'Dubbele invoeren zijn automatisch opgeschoond. Een back-up van de oorspronkelijke inschrijvingen zijn opgeslagen in <code>tl_newsletter_recipients_backup</code>.',
  ),
));
