...
$catalogue = new MessageCatalogue('fr', array (
  ...
  array (
    ...
    'password_confirmation_mismatch' => 'Le mot de passe ne correspond pas à la confirmation !',
    ...
    'update_tables_explain' => 'Veuillez, s\'il vous plaît, noter que l\'assistant de mises à jour gère uniquement les tables qui commencent par <code>tl_</code>.',
    'update_tables_confirm' => 'La base de données est à jour.',
    ...
    'template_import_explain' => 'Vous pouvez importer un fichier <code>.sql</code> à partir du répertoire <code>templates</code>. Les données existantes seront effacées ! Si vous souhaitez seulement importer un thème, utilisez le gestionnaire de thème dans le back office de Contao.',
    ...
    'admin_error_extnd' => 'Pour des raisons de sécurité, vous ne pouvez pas utiliser les caractères suivants ici : #()/<=>',
    ...
    'duplicate_subscriptions_begin' => 'Doublons d\'abonnements au bulletin d\'information trouvés :',
    'duplicate_subscriptions_end' => 'Les doublons ont été purgés automatiquement. Une copie de l\'abonnement d\'origine a été enregistrée dans <code>tl_newsletter_recipients_backup</code>',
  ),
));
