...
$catalogue = new MessageCatalogue('it', array (
  ...
  'messages' => 
  array (
    'install_tool' => 'Strumento di installazione Contao',
    'an_error_occurred' => 'Si è verificato un errore',
    'locked_headline' => 'Lo strumento di installazione è stato bloccato',
    'locked_explanation' => 'Per motivi di sicurezza, lo strumento di installazione è stato bloccato dopo che una password errata è stata inserita più di tre volte di seguito. È possibile sbloccarlo in Contao Manager o eseguendo <code>contao:install:unlock</code> sulla riga di comando.',
    'file_permissions_headline' => 'PHP non ha i permessi per la creazione di file.',
    'file_permissions_explanation' => 'Il server non supporta l\'accesso ai file tramite PHP; molto probabilmente PHP viene eseguito come modulo Apache con un utente diverso. Si prega di contattare l\'amministratore del server e chiedergli di risolvere il problema. ',
    'file_permissions_warning' => '<strong> Suggeriamo di non tentare in modo autonomo, dando i privilegi di lettura e scrittura a tutti!</ strong>',
    'accept_license' => 'Accetta la licenza',
    'set_password' => 'Password strumento di installazione',
    'set_password_hint' => 'Inserire una password per evitare accessi non autorizzati!',
    'password' => 'Password',
    ...
    'password_too_short' => 'La password deve essere lunga almeno %d caratteri!',
    'login' => 'Login',
    'login_explanation' => 'Inserire la password per lo strumento di installazione. Ricorda che la password non è la stessa del pannello di controllo di Contao.',
    'allow_cookies' => 'Occorre abilitare i cookie per poter utilizzare Contao.',
    'invalid_password' => 'Password non valida!',
    'database_connection' => 'Connessione al database',
    'database_connected' => 'Connessione al database eseguita correttamente.',
    'database_dot_in_dbname' => 'Il nome del database non deve contenere punti!',
    'database_could_not_connect' => 'Non è possibile effettuare la connessione al database!',
    'database_connection_explain' => 'Inserire i parametri per la connessione al database.',
    'database_host' => 'Host',
    'database_port' => 'Numero porta',
    'database_user' => 'Nome utente',
    'database_password' => 'Password',
    'database_name' => 'Nome Database',
    'save_settings' => 'Salva la configurazione',
    'update_tables' => 'Aggiorna il database',
    'update_tables_explain' => 'L\'aggiornamento guidato aggiornerà solamente le tabelle con prefisso <code>tl_</code>.',
    'update_tables_confirm' => 'Il database è aggiornato.',
    'update_save' => 'Aggiorna il database',
    'CREATE' => 'Tabelle create',
    'ALTER_ADD' => 'Aggiungi colonne',
    'ALTER_CHANGE' => 'Modifica colonne ',
    'ALTER_DROP' => 'Elimina colonne ',
    'DROP' => 'Elimina tabelle',
    'select_all' => 'Seleziona tutto',
    'template_import' => 'Importa un template',
    'template_import_explain' => 'Selezionare un file <em>.sql</em> dalla cartella <em>templates</em> per l\'importazione di un sito web di prova. Eventuali dati presenti saranno cancellati!!! Se invece si vuole importare un tema, utilizzare l\'apposita funzione nel backend.',
    'import_exception' => 'L\'importazione non è riuscita! E\' la struttura della banca dati aggiornata ed è il file della template compatibile con la tua versione Contao?',
    'import_empty_source' => 'Selezionare un file template',
    'import_data_will_be_deleted' => 'ATTENZIONE, ogni informazione esistente sarà cancellata!',
    'imported_on' => 'Template importato il %s',
    'templates' => 'Templates',
    'do_not_truncate' => 'Non troncare le tabelle',
    'import_confirm' => 'Ogni informazione esistente sarà cancellata. Vuoi procedere?',
    'template_save' => 'Importa templates',
    'admin_create' => 'Crea un utente amministratore',
    'admin_create_explain' => 'Qui è possibile creare un utente amministratore per il back end di Contao',
    'admin_confirm' => 'L\'utente amministratore è stato creato.',
    'admin_username' => 'Nome utente',
    'admin_name' => 'Nome',
    'admin_email' => 'Formato e-mail',
    'admin_save' => 'Crea un utente amministratore',
    'admin_error_extnd' => 'Per motivi di sicurezza non puoi utilizzare i seguenti caratteri: =<>&/()#',
    'admin_error_no_space' => 'Il nome utente non può contenere degli spazi!',
    'admin_error_email' => 'Inserisci un indirizzo e-mail valido!',
    'admin_error_password_match' => 'Le password non coincidono!',
    'admin_error_password_user' => 'Username e password non possono essere uguali!',
    'admin_error' => 'Indicare tutte le informazioni per creare un utente amministratore',
    'congratulations' => 'Contao è stato configurato correttamente!',
    'congratulations_explain' => 'L\'installazione di Contao è avvenuta con successo',
    'installation_complete' => 'Installazione completa',
    'installation_complete_explain' => 'Ora è possibile accedere al back end di Contao e verificare le impostazioni di sistema',
    'back_end' => 'Backend di Contao ',
    'old_database' => 'Il database non è aggiornato!',
    'old_database_explanation' => 'E\' necessario almeno Contao 3.2 per eseguire l\'aggiornamento a Contao 4.',
    'console_explanation' => 'Il task post installazione non è stato completato!',
    'duplicate_subscriptions' => 'Duplicare gli abbonamenti',
    'duplicate_subscriptions_begin' => 'Trovati iscritti alla newsletter duplicati:',
    'duplicate_subscriptions_end' => 'Le voci duplicate sono state eliminate automaticamente. Un backup degli iscritti originali è stato archiviato in <code>tl_newsletter_recipients_backup</code>.',
  ),
));
