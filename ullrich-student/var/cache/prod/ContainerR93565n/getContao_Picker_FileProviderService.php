...
// Returns the private 'contao.picker.file_provider' shared service.

$this->services['contao.picker.file_provider'] = $instance = new \Contao\CoreBundle\Picker\FilePickerProvider(${($_ = isset($this->services['knp_menu.factory']) ? $this->services['knp_menu.factory'] : $this->load('getKnpMenu_FactoryService.php')) && false ?: '_'}, ${($_ = isset($this->services['router']) ? $this->services['router'] : $this->getRouterService()) && false ?: '_'}, 'files');
