...
$GLOBALS['TL_LANG']['MOD']['tl_news'] = 'Articles';
 ...
 * Page types.
 */
$GLOBALS['TL_LANG']['MOD']['folderpage'] = ['Page type "folder"'];
...
$GLOBALS['TL_LANG']['CTE']['bs_gridSeparator'][1] = 'Grid Separator Element';
$GLOBALS['TL_LANG']['CTE']['bs_gridStop'][0]      = 'Grid Stop';
$GLOBALS['TL_LANG']['CTE']['bs_gridStop'][1]      = 'Grid Stop Element';
$GLOBALS['TL_LANG']['CTE']['bs_grid_gallery'][0]  = 'Gallery (Bootstrap grid)';
$GLOBALS['TL_LANG']['CTE']['bs_grid_gallery'][1]  = 'Gallery using Bootstrap grid';
...
// vendor/contao-themes-net/mate-theme-bundle/src/Resources/contao/languages/en/modules.xlf
