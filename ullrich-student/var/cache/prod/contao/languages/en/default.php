...
$GLOBALS['TL_LANG']['MSC']['move'] = 'Move the item via drag and drop or the up and down keys';
...
$GLOBALS['TL_LANG']['MSC']['shortcuts'][1] = 'Learn more about speeding up your workflow by using <a href="https://docs.contao.org/manual/en/administration-area/back-end-keyboard-shortcuts/" title="Keyboard shortcuts overview" target="_blank">keyboard shortcuts</a>.';
...
$GLOBALS['TL_LANG']['MSC']['burgerTitle'] = 'Toggle navigation';
...
$GLOBALS['TL_LANG']['MSC']['maintenanceEnabled'] = 'The maintenance mode is currently enabled.';
...
$GLOBALS['TL_LANG']['MSC']['metaNoLanguages'] = 'You have to add a root page in the site structure to enter file meta data.';
...
$GLOBALS['TL_LANG']['ERR']['blacklisted'] = 'The e-mail address has been unsubscribed from the channel.';
...
$GLOBALS['TL_LANG']['ERR']['bsGridParentMissing'] = 'No parent element connected';

// vendor/contao-dd/advanced-classes-bundle/src/Resources/contao/languages/en/default.xlf
$GLOBALS['TL_LANG']['MOD']['advanced_classes'][0] = 'Advanced Classes';
$GLOBALS['TL_LANG']['MOD']['advanced_classes'][1] = 'Extend the css classes of Contao elements.';
$GLOBALS['TL_LANG']['FMD']['advanced_classes'] = 'Advanced Classes';
$GLOBALS['TL_LANG']['tl_content']['advanced_classes_legend'] = 'Advanced CSS classes';
$GLOBALS['TL_LANG']['tl_content']['advancedCss'][0] = 'Extended CSS Classes';
$GLOBALS['TL_LANG']['tl_content']['advancedCss'][1] = 'Here you can set css classes by a simple form';
