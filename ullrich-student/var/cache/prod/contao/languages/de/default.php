...
$GLOBALS['TL_LANG']['MSC']['move'] = 'Das Element durch Ziehen und Ablegen oder mittels der Pfeiltasten verschieben';
...
$GLOBALS['TL_LANG']['MSC']['shortcuts'][1] = 'Wie Sie Ihren Arbeitsablauf durch die Verwendung von <a href="https://docs.contao.org/manual/de/administrationsbereich/backend-tastaturkuerzel/" target="_blank">Tastaturkürzeln</a> beschleunigen.';
...
$GLOBALS['TL_LANG']['MSC']['burgerTitle'] = 'Navigation umschalten';
...
$GLOBALS['TL_LANG']['MSC']['maintenanceEnabled'] = 'Der Wartungsmodus ist aktiv.';
...
$GLOBALS['TL_LANG']['MSC']['versionConflict2'] = 'Ihre Änderungen wurden nun als Version %s gespeichert und haben die Änderungen der Version %s potentiell überschrieben, daher sollten Sie die nachstehenden Versionen vergleichen:';
...
$GLOBALS['TL_LANG']['ERR']['blacklisted'] = 'Die E-Mail-Adresse wurde aus dem Verteiler ausgetragen.';
...
$GLOBALS['TL_LANG']['MSC']['tw_rnew']
    = 'Eine neue Reihe erstellen.';
$GLOBALS['TL_LANG']['MSC']['tw_rmove']
    = 'Die Reihe verschieben.';
...
$GLOBALS['TL_LANG']['ERR']['topLevelRegular'] = 'Auf der obersten Ebene befinden sich Seiten, die keine Website-Startpunkte oder Ordner sind. Webseiten ohne Startpunkt werden nicht mehr unterstützt, daher stellen Sie bitte sicher, dass alle Seiten unter einem Startpunkt gruppiert sind.';
 ...
 *
 * last-updated: 2018-07-27T14:50:13+00:00
 */


$GLOBALS['TL_LANG']['ERR']['bsGridParentMissing'] = 'Kein Elternelement verbunden';

// vendor/contao-dd/advanced-classes-bundle/src/Resources/contao/languages/de/default.xlf
$GLOBALS['TL_LANG']['MOD']['advanced_classes'][0] = 'Erweiterte CSS-Klassen';
$GLOBALS['TL_LANG']['MOD']['advanced_classes'][1] = 'Erweitert die CSS-Klassen der Contao Elemente.';
$GLOBALS['TL_LANG']['FMD']['advanced_classes'] = 'Erweiterte CSS-Klassen';
$GLOBALS['TL_LANG']['tl_content']['advanced_classes_legend'] = 'Erweiterte CSS-Klassen';
$GLOBALS['TL_LANG']['tl_content']['advancedCss'][0] = 'Erweiterte CSS-Klassen';
$GLOBALS['TL_LANG']['tl_content']['advancedCss'][1] = 'Über ein einfaches Formular kannst du dem Element weitere CSS-Klassen hinzufügen.';
...
$GLOBALS['TL_LANG']['CTE']['mateNavbar'][1] = $GLOBALS['TL_LANG']['FMD']['mateTheme']['mateNavbar'][1] = $GLOBALS['TL_LANG']['CTE']['mateTheme']['navbar'][1] = 'Inhaltselement Navbar';
$GLOBALS['TL_LANG']['CTE']['mateTeaserBox'][0] = $GLOBALS['TL_LANG']['FMD']['mateTheme']['mateTeaserBox'][0] = 'Teaserbox';
$GLOBALS['TL_LANG']['CTE']['mateTeaserBox'][1] = $GLOBALS['TL_LANG']['FMD']['mateTheme']['mateTeaserBox'][1] = 'Inhaltselement Teaserbox';
...
$GLOBALS['TL_LANG']['CTE']['mateTextBackgroundElement'][0] = 'Text-Element mit Hintergrundbild';
...
$GLOBALS['TL_LANG']['tl_article']['th_tags']['MATE01/02'] = 'Header / 02';
...
$GLOBALS['TL_LANG']['MSC']['com_optInSubject'] = 'Ihr Newsletter-Abonnement auf %s';
